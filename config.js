...
const config = {
  ...
  //BotName
  inviteLink:
    "https://discord.com/api/oauth2/authorize?client_id=1154217363428868117&permissions=8&scope=bot%20applications.commands",
  //BotInvite Link
  Features: [
    {
      name: "Moderation",
  ...
  githubLink: "https://github.com/BrandonTheScripter",
  twitterLink: "",
  mediumLink: "",
  facebookLink: "",
  discordLink: "https://discord.gg/E3buQufFRC",
  youtubeLink: "",
};
